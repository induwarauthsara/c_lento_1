    ...
    if($user_rs->num_rows == 1){
       ...
       $_SESSION["u"] = "";
        ...
        if(empty($_SESSION["u"])){
         ...
         $mail->SMTPAuth = true;
         $mail->Username = 'eranga34063@gmail.com';
         $mail->Password = 'zfpexyuuqroriico';
         $mail->SMTPSecure = 'ssl';
         $mail->Port = 465;
         $mail->setFrom('eranga34063@gmail.com', 'Reset Password');
         $mail->addReplyTo('eranga34063@gmail.com', 'Reset Password');
